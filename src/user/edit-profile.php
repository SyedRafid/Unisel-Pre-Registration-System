...
if (strlen($_SESSION['id'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "Update user set name='$name', studentId='$sid', icno='$icno', intake='$intake', pCode='$program', contactNo='$contactno' where uid='" . $_SESSION['id'] . "'");
        if ($sql) {
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="panel panel-white">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    JOIN program ON user.pCode = program.pCode
                                                    WHERE user.uid='" . $_SESSION['id'] . "'");
                                                        ...
                                                        <form role="form" name="edit" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="program" class="form-control" required="true">
                                                                        ...
                                                                        <option value="<?php echo htmlentities($data['pName']); ?>">
                                                                            <?php echo htmlentities($data['pName']); ?></option>
