                ...
                <div class="main-content">
                    <div class="wrap-content container" id="container">
                        <section id="page-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle"> Admin | Student Pre-Registration History</h1>
                                </div>
                                <ol class="breadcrumb">
                                    <li>
                                        <?php
                        ...
                        <div class="container-fluid container-fullw bg-white">
                            ...
                            <div class="item-content" style="color: #3f3b3b; font-size: 24px;">
                                <?php
                                $sid = $_GET['sid'];
                                ...
                                if ($sql) {
                                    ...
                                    echo '<p style="font-family: \'themify\';">' . htmlentities($row['semesterName']) . '</p>';
                                }
                                ?>
                            </div>
                            <div class="row">
                                ...
                                $uid = $_GET['uid'];
                                $sid = $_GET['sid'];
                                $sql = mysqli_query($con, "SELECT semester.sid, course.courseName, course.courseCode, extracredit.reason
                                FROM semester
                                ...
                                WHERE semestercourse.uid = $uid AND semestercourse.sid = $sid");
